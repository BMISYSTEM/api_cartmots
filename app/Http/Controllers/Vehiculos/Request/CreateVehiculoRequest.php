     ...
     static function validate($request):array
    {
        $request = $request->validate(
            [
                ...
                'foto1' => 'required|max:5000|file|mimes:png,jpg,jpeg,webp,avif',
                'foto2' => 'required|max:5000|file|mimes:png,jpg,jpeg,webp,avif',
                'foto3' => 'required|max:5000|file|mimes:png,jpg,jpeg,webp,avif',
                'foto4' => 'required|max:5000|file|mimes:png,jpg,jpeg,webp,avif',
                'peritaje' => 'nullable',
                'proveedor'=>'nullable',
