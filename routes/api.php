...
use App\Http\Controllers\GeneradorReportes\Controllers\GeneradorReportes;
...
Route::middleware('auth:sanctum')->group(function(){
  ...
  /*
    ...
    */
    ...
    Route::post('/deletecontrato',[LogisticaController::class,'deleteContrato']);
    ...
    */
    ...
    Route::get('/syprodreport/layout/seccion',[GeneradorReportes::class,'seccionAll']);
    Route::post('/syprodreport/layout/reporte',[GeneradorReportes::class,'newReporte']);
    Route::get('/syprodreport/layout/reporte',[GeneradorReportes::class,'reportesAll']);
    ...
    Route::post('/syprodreport/layout/reporte/campos',[GeneradorReportes::class,'saveConfigCampos']);
     /*
    |--------------------------------------------------------------------------
    | rutas negocio
    |--------------------------------------------------------------------------
